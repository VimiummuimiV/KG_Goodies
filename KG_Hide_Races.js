...
const toggleButtonIconSize = 18;
const toggleButtonStrokeWidth = 2;
const toggleButtonStrokeColor = "hsl(0, 0%, 10%)";
...
const eyeIcon = encodeSVG(`
    <svg xmlns='http://www.w3.org/2000/svg' width='${toggleButtonIconSize}' height='${toggleButtonIconSize}' viewBox='0 0 24 24' fill='none' stroke='${toggleButtonStrokeColor}' stroke-width='${toggleButtonStrokeWidth}' stroke-linecap='round' stroke-linejoin='round'>
...
hideGamesInput.style.backgroundColor = 'hsl(210, 5%, 40%)';
...
hideGamesInput.addEventListener('mouseover', function () {
    hideGamesInput.style.backgroundColor = 'hsl(30, 65%, 50%)';
});
